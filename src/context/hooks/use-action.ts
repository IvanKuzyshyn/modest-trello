...
import {
    CreateCardAction,
    CreateColumnAction, DeleteCardAction,
    DeleteColumnAction,
    EditCardAction,
    EditColumnAction,
    ReadAllCardsAction,
...
const HANDLERS: Record<StateAction, Function> = {
    [StateAction.READ_ALL_COLUMNS]: (dispatch: Dispatch<ReadAllColumnsAction>) => () => {
    ...
    [StateAction.READ_ALL_CARDS]: (dispatch: Dispatch<ReadAllCardsAction>) => () => {
    ...
    [StateAction.CREATE_COLUMN]: (dispatch: Dispatch<CreateColumnAction>) => (data: DraftColumn) => {
    ...
    [StateAction.CREATE_CARD]: (dispatch: Dispatch<CreateCardAction>) => (data: DraftCard) => {
    ...
    [StateAction.EDIT_COLUMN]: (dispatch: Dispatch<EditColumnAction>) => (id: number, data: DraftColumn) => {
    ...
    [StateAction.EDIT_CARD]: (dispatch: Dispatch<EditCardAction>) => (id: number, data: DraftCard) => {
    ...
    [StateAction.DELETE_COLUMN]: (dispatch: Dispatch<DeleteColumnAction>) => (id: number) => {
    ...
    [StateAction.DELETE_CARD]: (dispatch: Dispatch<DeleteCardAction>) => (id: number) => {

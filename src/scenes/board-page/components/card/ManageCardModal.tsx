...
export const ManageCardModal = ({ onCreate, onEdit, onClose, parentColumnId, id }: Props) => {
    ...
    const handleChangeColumn = (event: React.ChangeEvent<HTMLSelectElement>) => setColumn(Number(event.target.value))
